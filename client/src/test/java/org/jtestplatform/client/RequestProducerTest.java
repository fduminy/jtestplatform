...
*/
        ...
        assertThat(actualRequests.getAllValues()).usingElementComparator(new RequestComparator()).as("requests")
                                                 .containsOnlyOnce(expectedRequests.toArray(new Request[0]));
