...
public class NetworkBuilderTest extends AbstractDomainTest {
    ...
    public void setUp() throws Exception {
        networkConfig = new NetworkConfig(EXPECTED_NETWORK_NAME, "12:34:56:", "127.0.0.", 1, 3);

        when(networkXMLBuilder.build(networkConfig)).thenReturn(NETWORK_XML);
    ...
    public void build() throws Exception {
        ...
        Network network = builder.build(connect, networkConfig);
